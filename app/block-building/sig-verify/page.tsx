...
import { signatureVerifyFiles } from "@/lib/constants";
...
export const metadata = constructMetaData({
  title: "Signature-Verification Stage | AGAVE Map",
  description: "This is the Signature Verification Stage page",
});
...
const signatureVerifySteps: Step[] = [
  {
    title: "Clone Empty Repository",
    description: "First, clone the empty Agave repository",
    command:
      "git clone --filter=blob:none --sparse https://github.com/anza-xyz/agave.git agave-sigverify-stage && cd agave-sigverify-stage",
  },
  {
  ...
  },
  {
    ...
    description:
      "Run the following command to compile only the signature verification related packages",
    command:
      "cargo build --package solana-core --package solana-runtime --package solana-sdk",
  },
];

export default function SignatureVerificationStagePage() {
  return (
    <div>
        ...
        <div className="container mx-auto flex flex-col items-center justify-center gap-12 p-12">
          <div className="flex flex-col items-center justify-center">
            ...
            <Checkout
              ...
              title="Clone Signature Verification Stage to your repo"
            />
          </div>
